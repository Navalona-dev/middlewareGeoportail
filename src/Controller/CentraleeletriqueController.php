...
class CentraleeletriqueController extends AbstractController
{
    private $pathImage = null;
    private $pathImageCentraleelectrique = null;
    private $pathPublic = null;
    private $pathForNamePhotoCentraleelectrique = null;
    private $kernelInterface;
    private $directoryCopy = null;
    private const nameRepertoireImage = 'ce_centrale_electrique/t_ce_01_infrastructure/';
    ...
    public function __construct(ParameterBagInterface $params, KernelInterface  $kernelInterface) {
        ...
        $this->pathImageCentraleelectrique = $params->get('pathImageCentraleelectrique');
        $this->pathPublic = $params->get('pathPublic');
        $this->pathForNamePhotoCentraleelectrique = $params->get('pathForNamePhotoCentraleelectrique');
    ...
    public function getPhotosByInfra($id, Request $request, CentraleelectriqueService $centraleelectriqueService)
    {
        ...
        if (isset($id) && !empty($id)) {
            $infoPhotosInfra = $centraleelectriqueService->getPhotoInfraInfo($id);
    ...
    { 
        ...
        try {
            if (0 === strpos($request->headers->get('Content-Type'), 'application/json')) {
                ...
                $infoPhotosInfra = $centraleelectriqueService->getPhotoInfraInfo($idInfra);
                ...
                $directory = $this->pathImageCentraleelectrique . $indexPhoto."/";
                ...
                if (array_key_exists($indexPhoto, $oldPhotosInfra)) {
                    ...
                    if (isset($setUpdate) && !empty($setUpdate)) {
                        $idInfra = $centraleelectriqueService->addInfrastructurePhoto($idInfra, $setUpdate);
                    }
                   
                    $response->setContent(json_encode([
                        'code'  => Response::HTTP_OK,
                        'status' => true,
                        'message' => "Photo centraleelectrique route deleted_successfull"
                    ]));
                } else {
                    $response->setContent(json_encode([
                        'code'  => Response::HTTP_OK,
                        'status' => true,
                        'message' => "Pas de photo centraleelectrique route supprimer"
                    ]));
                }
    ...
    { 
        ...
        try {
            ...
            if(!is_dir($this->pathImageCentraleelectrique)) {
                mkdir($this->pathImageCentraleelectrique, 0777, true);
            }
          
            $directory1 = $this->pathImageCentraleelectrique . "photo1/";
            ...
            if (null != $uploadedFile1 && "null" != $uploadedFile1 && "undefined" != $uploadedFile1) {
                ...
                $data['photo1'] = $this->pathForNamePhotoCentraleelectrique."photo1/" .$nomPhoto1;
            ...
            $directory2 = $this->pathImageCentraleelectrique . "photo2/";
            ...
            if (null != $uploadedFile2 && "null" != $uploadedFile2 && "undefined" != $uploadedFile2) {
                ...
                $data['photo2'] = $this->pathForNamePhotoCentraleelectrique."photo2/" .$nomPhoto2;
            ...
            $directory3 = $this->pathImageCentraleelectrique . "photo3/";
            ...
            if (null != $uploadedFile3 && "null" != $uploadedFile3 && "undefined" != $uploadedFile3) {
                ...
                $data['photo3'] = $this->pathForNamePhotoCentraleelectrique."photo3/" .$nomPhoto3;
            ...
            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "Photo centraleelectrique route updated_successfull"
            ]));
    ...
    {    
        ...
        try {
            ...
            $data['puissanceNominale'] = $request->get('puissanceNominale');

            $data['latitude'] = $request->get('latitude');
            $data['longitude'] = $request->get('longitude');
            $data['indicatif'] = 'IM.E_01_01';
            ...
            // Data collecte
            $data['puissanceDisponible'] = $request->get('puissanceDisponible');
            $data['etatBarrage'] = $request->get('etatBarrage');
            $data['etatTurbine'] = $request->get('etatTurbine');
            $data['etatGroupe'] = $request->get('etatGroupe');
            $data['etatPanneauxSolaire'] = $request->get('etatPanneauxSolaire');
            $data['etatEolienne'] = $request->get('etatEolienne');
            $data['etatGenieCivilBiomasse'] = $request->get('etatGenieCivilBiomasse');
            ...
            if ($request->get('categorie') != "null" && $request->get('categorie') != "undefined") {
                $allCategories = $centraleelectriqueService->getAllCategorieInfra();
            ...
            $idInfra = $centraleelectriqueService->addInfrastructure($data);

            if ($idInfra != false) {
                // add situation et etat
                //$idEtat = $centraleelectriqueService->addInfrastructureRouteEtat($idInfra, $data);

                $idEtat = $centraleelectriqueService->addInfrastructureSituation($idInfra, $data);

                $idDataCollected = $centraleelectriqueService->addInfrastructureDonneCollecte($idInfra, $data);

                /*$idStructure = $centraleelectriqueService->addInfrastructureRouteStructure($idInfra, $data);

                $idAccotement = $centraleelectriqueService->addInfrastructureRouteAccotement($idInfra, $data);

                $idFosse = $centraleelectriqueService->addInfrastructureRouteFosse($idInfra, $data);*/
                ...
                $idFoncier = $centraleelectriqueService->addInfrastructureRouteFoncier($idInfra, $data);*/
                ...
                if (null != $request->get('hasTravaux') && ($request->get('hasTravaux') == true || $request->get('hasTravaux') == "true") && "false" != $request->get('hasTravaux')) {
                    ...
                    $idTravaux = $centraleelectriqueService->addInfrastructureTravaux($idInfra, $data);
                }
                ...
                $idFourniture = $centraleelectriqueService->addInfrastructureRouteFourniture($idInfra, $data);*/
                // Etudes
                ...
                // $data['precisionConsistanceContratEtude'] = $request->get('precisionConsistanceContratEtude');
                    ...
                    $idEtude = $centraleelectriqueService->addInfrastructureEtudes($idInfra, $data);
                }
                
                /**
                 * End Administrative data
                */
                //$idDonneAnnexe = $centraleelectriqueService->addInfrastructureEducationDonneAnnexe($idInfra, $data);
            }

            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "centraleelectrique route created_successfull"
            ]));
        ...
        if ($hasException) {// Clean database
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'infrastructure');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'situation');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'data');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'travaux');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'etude');
            /*
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'surface');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'structure');
            
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'accotement');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'fosse');
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'foncier');
           
            $centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'fourniture');*/
    ...
    {    
        ...
        try {
            ...
            $routes = $centraleelectriqueService->getAllInfrastructures();

            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "centraleelectrique route list_successfull",
                'pathImage' => $this->pathImage,
                'data' => $routes
            ]));
    ...
    {    
        ...
        try {
            ...
            $routes = $centraleelectriqueService->getAllInfrastructuresMinifie();
    ...
    {    
        ...
        try {
            ...
            $routes = $centraleelectriqueService->getOneInfraInfo(intval($infraId));
    ...
    {    
        ...
        try {
            ...
            if (0 === strpos($request->headers->get('Content-Type'), 'application/json')) {
                ...
                'id_ingenieurs_reception_definitive', 'puissance_disponible', 'montant_contrat', 'nombre_voies', 'pk_debut', 'pk_fin', 'capacite_de_voiture_accueillies'];
                ...
                if (array_key_exists('infrastructure', $data) && count($data['infrastructure']) > 0) {
                    ...
                    $idInfra = $centraleelectriqueService->updateInfrastructure($idInfra, $updateColonneInfra);
                    }
                }
                // Situation
                ...
                if (array_key_exists('situations', $data) && count($data['situations']) > 0) {
                    ...
                    if ($idSituation == 0) {
                        $idSituation = $centraleelectriqueService->addInfoInTableByInfrastructure('t_ce_03_situation', $colonneInsert, $valuesInsert);
                    } else {
                        if (isset($updateColonneEtat) && !empty($updateColonneEtat)) {
                        $idSituation = $centraleelectriqueService->updateInfrastructureTables('t_ce_03_situation', $idSituation, $updateColonneEtat);
                        }
                    } 
                ...
                if (array_key_exists('data_collecte', $data) && count($data['data_collecte']) > 0) {
                    ...
                    if ($idData == 0) {
                        $idData = $centraleelectriqueService->addInfoInTableByInfrastructure('t_ce_06_donnees_collectees', $colonneInsert, $valuesInsert);
                    } else {
                        if (isset($updateColonneData) && !empty($updateColonneData)) {
                        $idData = $centraleelectriqueService->updateInfrastructureTables('t_ce_06_donnees_collectees', $idData, $updateColonneData);
                        }
                    }
                }
                // Travaux
                ...
                if (array_key_exists('travaux', $data) && count($data['travaux']) > 0) {
                    ...
                    if ($idTravaux == 0) {
                        $idTravaux = $centraleelectriqueService->addInfoInTableByInfrastructure('t_bc_05_travaux', $colonneInsert, $valuesInsert);
                    } else {
                        if (isset($updateColonneTravaux) && !empty($updateColonneTravaux)) {
                        $idTravaux = $centraleelectriqueService->updateInfrastructureTables('t_bc_05_travaux', $idTravaux, $updateColonneTravaux);
                        }
                    }
                }
                ...
                if (array_key_exists('etudes', $data) && count($data['etudes']) > 0) {
                    ...
                    if ($idEtudes == 0) {
                        $idEtudes = $centraleelectriqueService->addInfoInTableByInfrastructure('t_bc_07_etudes', $colonneInsert, $valuesInsert);
                    } else {
                        if (isset($updateColonneEtudes) && !empty($updateColonneEtudes)) {
                        $idEtudes = $centraleelectriqueService->updateInfrastructureTables('t_bc_07_etudes', $idEtudes, $updateColonneEtudes);
                        }
                    }
                }
            }
            ...
            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "centraleelectrique update_successfull"
            ]));
        ...
        if ($hasException) {// Clean database
            //$centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'infrastructure');
            //$centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'etat');
            //$centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'data');
            //$centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'travaux');
            //$centraleelectriqueService->cleanTablesByIdInfrastructure($idInfra, 'etude');
            /*
