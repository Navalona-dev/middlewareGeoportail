...
class CheminferController extends AbstractController
{
    ...
    { 
        ...
        try {
            if (0 === strpos($request->headers->get('Content-Type'), 'application/json')) {
                ...
                $infoPhotosInfra = $cheminferService->getPhotoInfraInfo($idInfra);
                ...
                $directory = $this->pathImageCheminfer . $indexPhoto."/";
    ...
    { 
        ...
        try {
            ...
            if(!is_dir($this->pathImageCheminfer)) {
    ...
    {    
        ...
        try {
            ...
            $idInfra = $cheminferService->addInfrastructure($data);

            if ($idInfra != false) {
                // add situation et etat
                //$idEtat = $cheminferService->addInfrastructureRouteEtat($idInfra, $data);

                $idEtat = $cheminferService->addInfrastructureSituation($idInfra, $data);

                $idDataCollected = $cheminferService->addInfrastructureDonneCollecte($idInfra, $data);

                /*$idStructure = $cheminferService->addInfrastructureRouteStructure($idInfra, $data);

                $idAccotement = $cheminferService->addInfrastructureRouteAccotement($idInfra, $data);

                $idFosse = $cheminferService->addInfrastructureRouteFosse($idInfra, $data);*/
                ...
                $idFoncier = $cheminferService->addInfrastructureRouteFoncier($idInfra, $data);*/
                ...
                if (null != $request->get('hasTravaux') && ($request->get('hasTravaux') == true || $request->get('hasTravaux') == "true") && "false" != $request->get('hasTravaux')) {
                    ...
                    $idTravaux = $cheminferService->addInfrastructureTravaux($idInfra, $data);
                }
                ...
                $idFourniture = $cheminferService->addInfrastructureRouteFourniture($idInfra, $data);*/
                // Etudes
                ...
                // $data['precisionConsistanceContratEtude'] = $request->get('precisionConsistanceContratEtude');
                    ...
                    $idEtude = $cheminferService->addInfrastructureEtudes($idInfra, $data);
                }
                
                /**
                 * End Administrative data
                */
                //$idDonneAnnexe = $cheminferService->addInfrastructureEducationDonneAnnexe($idInfra, $data);
            }

            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "cheminfer route created_successfull"
            ]));
    ...
    {    
        ...
        try {
            ...
            $routes = $cheminferService->getAllInfrastructures();
    ...
    {    
        ...
        try {
            ...
            $routes = $cheminferService->getAllInfrastructuresMinifie();
    ...
    {    
        ...
        if ($hasException) {// Clean database
            //$cheminferService->cleanTablesByIdInfrastructure($idInfra, 'infrastructure');
            //$cheminferService->cleanTablesByIdInfrastructure($idInfra, 'etat');
            //$cheminferService->cleanTablesByIdInfrastructure($idInfra, 'data');
            //$cheminferService->cleanTablesByIdInfrastructure($idInfra, 'travaux');
            //$cheminferService->cleanTablesByIdInfrastructure($idInfra, 'etude');
            /*
