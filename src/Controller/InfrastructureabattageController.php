...
use App\Service\InfrastructureabattageService;
...
class InfrastructureabattageController extends AbstractController
{
    private $pathImage = null;
    private $pathImageInfrastructureabattage = null;
    private $pathPublic = null;
    private $pathForNameInfrastructureabattage = null;
    private $kernelInterface;
    private $directoryCopy = null;
    private const nameRepertoireImage = 'ia_infrastructure_abattage/t_ia_01_infrastructure/';
    ...
    public function __construct(ParameterBagInterface $params, KernelInterface  $kernelInterface) {
        ...
        $this->pathImageInfrastructureabattage = $params->get('pathImageInfrastructureabattage');
        $this->pathPublic = $params->get('pathPublic');
        $this->pathForNameInfrastructureabattage = $params->get('pathForNameInfrastructureabattage');
    ...
    /**
     * @Route("/api/infrastructureabattage/getphoto/{id}", name="infra_infrastructureabattage_photo", methods={"GET"})
     */
    public function getPhotosByInfra($id, Request $request, InfrastructureabattageService $infrastructureabattageService)
    {
        $infoPhotosInfra = [];
        $response = new Response();
        if (isset($id) && !empty($id)) {
            $infoPhotosInfra = $infrastructureabattageService->getPhotoInfraInfo($id);
    ...
    /**
     * @Route("/api/infrastructureabattage/deletephoto", name="infrastructureabattage_delete_photo", methods={"POST"})
     */
    public function deletePhoto(Request $request, InfrastructureabattageService $infrastructureabattageService)
    { 
        $response = new Response();
        $hasException = false;
        $idInfra = null;
        try {
            if (0 === strpos($request->headers->get('Content-Type'), 'application/json')) {
                ...
                $infoPhotosInfra = $infrastructureabattageService->getPhotoInfraInfo($idInfra);
                ...
                $directory = $this->pathImageInfrastructureabattage . $indexPhoto."/";
                ...
                if (array_key_exists($indexPhoto, $oldPhotosInfra)) {
                    ...
                    if (isset($setUpdate) && !empty($setUpdate)) {
                        $idInfra = $infrastructureabattageService->addInfrastructurePhoto($idInfra, $setUpdate);
                    }
                   
                    $response->setContent(json_encode([
                        'code'  => Response::HTTP_OK,
                        'status' => true,
                        'message' => "Photo infrastructureabattage route deleted_successfull"
                    ]));
                } else {
                    $response->setContent(json_encode([
                        'code'  => Response::HTTP_OK,
                        'status' => true,
                        'message' => "Pas de photo infrastructureabattage route supprimer"
                    ]));
                }
    ...
    /**
     * @Route("/api/infrastructureabattage/updatephoto", name="infrastructureabattage_update_photo", methods={"POST"})
     */
    public function updatePhoto(Request $request, InfrastructureabattageService $infrastructureabattageService)
    { 
        $response = new Response();
        $hasException = false;
        $idInfra = null;
        try {
            ...
            if(!is_dir($this->pathImageInfrastructureabattage)) {
                mkdir($this->pathImageInfrastructureabattage, 0777, true);
            }
          
            $directory1 = $this->pathImageInfrastructureabattage . "photo1/";
            ...
            if (null != $uploadedFile1 && "null" != $uploadedFile1 && "undefined" != $uploadedFile1) {
                ...
                $data['photo1'] = $this->pathForNameInfrastructureabattage."photo1/" .$nomPhoto1;
            ...
            $directory2 = $this->pathImageInfrastructureabattage . "photo2/";
            ...
            if (null != $uploadedFile2 && "null" != $uploadedFile2 && "undefined" != $uploadedFile2) {
                ...
                $data['photo2'] = $this->pathForNameInfrastructureabattage."photo2/" .$nomPhoto2;
            ...
            $directory3 = $this->pathImageInfrastructureabattage . "photo3/";
            ...
            if (null != $uploadedFile3 && "null" != $uploadedFile3 && "undefined" != $uploadedFile3) {
                ...
                $data['photo3'] = $this->pathForNameInfrastructureabattage."photo3/" .$nomPhoto3;
            ...
            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "Photo infrastructureabattage route updated_successfull"
            ]));
    ...
    /**
     * @Route("/api/infrastructureabattage/add", name="infrastructureabattage_add", methods={"POST"})
     */
    public function create(Request $request, InfrastructureabattageService $infrastructureabattageService)
    {    
        $response = new Response();
        $hasException = false;
        $idInfra = null;
        try {
            ...
            if ($request->get('categorie') != "null" && $request->get('categorie') != "undefined") {
                $allCategories = $infrastructureabattageService->getAllCategorieInfra();
            ...
            $idInfra = $infrastructureabattageService->addInfrastructure($data);

            if ($idInfra != false) {
                // add situation et etat
                //$idEtat = $infrastructureabattageService->addInfrastructureRouteEtat($idInfra, $data);

                $idEtat = $infrastructureabattageService->addInfrastructureSituation($idInfra, $data);

                $idDataCollected = $infrastructureabattageService->addInfrastructureDonneCollecte($idInfra, $data);

                /*$idStructure = $infrastructureabattageService->addInfrastructureRouteStructure($idInfra, $data);

                $idAccotement = $infrastructureabattageService->addInfrastructureRouteAccotement($idInfra, $data);

                $idFosse = $infrastructureabattageService->addInfrastructureRouteFosse($idInfra, $data);*/
                ...
                $idFoncier = $infrastructureabattageService->addInfrastructureRouteFoncier($idInfra, $data);*/
                ...
                if (null != $request->get('hasTravaux') && ($request->get('hasTravaux') == true || $request->get('hasTravaux') == "true") && "false" != $request->get('hasTravaux')) {
                    ...
                    $idTravaux = $infrastructureabattageService->addInfrastructureTravaux($idInfra, $data);
                }
                ...
                $idFourniture = $infrastructureabattageService->addInfrastructureRouteFourniture($idInfra, $data);*/
                // Etudes
                ...
                // $data['precisionConsistanceContratEtude'] = $request->get('precisionConsistanceContratEtude');
                    ...
                    $idEtude = $infrastructureabattageService->addInfrastructureEtudes($idInfra, $data);
                }
                
                /**
                 * End Administrative data
                */
                //$idDonneAnnexe = $infrastructureabattageService->addInfrastructureEducationDonneAnnexe($idInfra, $data);
            }

            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "infrastructureabattage route created_successfull"
            ]));
        ...
        if ($hasException) {// Clean database
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'infrastructure');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'situation');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'data');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'travaux');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'etude');
            /*
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'surface');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'structure');
            
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'accotement');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'fosse');
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'foncier');
           
            $infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'fourniture');*/
    ...
    /**
     * @Route("/api/infra/infrastructureabattage/liste", name="infrastructureabattage_list", methods={"GET"})
     */
    public function listeinfrastructureabattage(Request $request, InfrastructureabattageService $infrastructureabattageService)
    {    
        $response = new Response();
        
        try {

            $routes = $infrastructureabattageService->getAllInfrastructures();

            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "infrastructureabattage route list_successfull",
                'pathImage' => $this->pathImage,
                'data' => $routes
            ]));
    ...
    /**
     * @Route("/api/infra/infrastructureabattage/liste/minifie", name="infrastructureabattage_list_minifie", methods={"GET"})
     */
    public function listeinfrastructureabattageMinifie(Request $request, InfrastructureabattageService $infrastructureabattageService)
    {    
        $response = new Response();
        
        try {

            $routes = $infrastructureabattageService->getAllInfrastructuresMinifie();
    ...
    /**
     * @Route("/api/infra/infrastructureabattage/info", name="infrastructureabattage_info", methods={"POST"})
     */
    public function getOneInfraInfo(Request $request, InfrastructureabattageService $infrastructureabattageService)
    {    
        $response = new Response();
        ...
        try {
            ...
            $routes = $infrastructureabattageService->getOneInfraInfo(intval($infraId));
    ...
    /**
     * @Route("/api/infrastructureabattage/update", name="infrastructureabattage_update", methods={"POST"})
     */
    public function update(Request $request, InfrastructureabattageService $infrastructureabattageService)
    {    
        $response = new Response();
        $hasException = false;
        $idInfra = null;
        try {
            ...
            if (0 === strpos($request->headers->get('Content-Type'), 'application/json')) {
                ...
                if (array_key_exists('infrastructure', $data) && count($data['infrastructure']) > 0) {
                    ...
                    $idInfra = $infrastructureabattageService->updateInfrastructure($idInfra, $updateColonneInfra);
                    }
                }
                // Situation
                ...
                if (array_key_exists('situations', $data) && count($data['situations']) > 0) {
                    ...
                    if ($idSituation == 0) {
                        $idSituation = $infrastructureabattageService->addInfoInTableByInfrastructure('t_ia_03_situation', $colonneInsert, $valuesInsert);
                    } else {
                        if (isset($updateColonneEtat) && !empty($updateColonneEtat)) {
                        $idSituation = $infrastructureabattageService->updateInfrastructureTables('t_ia_03_situation', $idSituation, $updateColonneEtat);
                        }
                    } 
            ...
            $response->setContent(json_encode([
                'code'  => Response::HTTP_OK,
                'status' => true,
                'message' => "infrastructureabattage update_successfull"
            ]));
        ...
        if ($hasException) {// Clean database
            //$infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'infrastructure');
            //$infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'etat');
            //$infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'data');
            //$infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'travaux');
            //$infrastructureabattageService->cleanTablesByIdInfrastructure($idInfra, 'etude');
            /*
