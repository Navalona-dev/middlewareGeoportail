...
class LocalisationInfrastructureController extends AbstractController
{
    ...
    {    
     ...
     /**
     * @Route("/api/localites/infrastructure", name="localites_infrastructure", methods={"GET"})
     */
    public function getLocalitesInfrastructure(Request $request, LocalisationInfrastructureService $localisationInfrastructureService)
    {    
        $response = new Response();
