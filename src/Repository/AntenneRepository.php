...
class AntenneRepository extends ServiceEntityRepository
{
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_ar_06_donnees_collectees (id_infrastructure, etat_fondation_pylone, etat_pylone, etat_antenne, etat_materiels, date_information, source_information, mode_acquisition_information) VALUES (".intval($idInfrastructure).", '".$etatFondationPylone."', '".$etatPylone."', '".$etatAntenne."', '".$etatMateriels."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."')";
