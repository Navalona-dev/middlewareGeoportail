...
class BarragehydroRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $type = null, $longueurBarrage = null, $superficieDominee = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $precisionType = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null)
    {
        ...
        $sql = "INSERT into t_bh_01_infrastructure (nom, indicatif, categorie, \"type\", longueur_barrage, superficie_dominee,localite, commune_terrain, date_information, source_information, mode_acquisition_information, geom, photo_name1, photo_name2, photo_name3, photo1, photo2, photo3, district, region, precision_type) VALUES ('".$nom."', '".$indicatif."', '".$categorie."', '".$type."', ".floatval($longueurBarrage).", ".floatval($superficieDominee).", '".$localite."', '".$communeTerrain."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', ST_GeomFromText('POINT(" . $longitude . " " . $latitude . ")', 4326), '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$photo1."', '".$photo2."', '".$photo3."', '".$district."', '".$region."', '".$precisionType."')";
    ...
    {
        $sql = "UPDATE t_bh_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_bh_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
    ...
    {
        $sql = 'SELECT infra.id as infra_id, infra.nom as nom, infra.categorie, infra.longueur_barrage, infra.type, infra.superficie_dominee, infra.localite, infra.commune_terrain, infra.date_information, infra.source_information as source_information, infra.mode_acquisition_information as mode_acquisition_information, infra.district,  ST_X(infra.geom) AS longitude, ST_Y(infra.geom) AS latitude, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3  FROM t_bh_01_infrastructure as infra';
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_bh_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_bh_02_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_bh_04_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_bh_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_bh_02_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $betonExistenceFissureBeton = null, $betonExistenceFerraillageVisible = null,$betonExistenceAffoullementPiedOuvrage, $betonExistenceErosionLongRivesBarrage, $betonAncrageOuvrageRivesCoursEau = null, $remblaiFissurationDesRemblais = null, $remblaiRavinement = null, $remblaiErosionLongRechargeAval = null, $remblaiEffetBatillageParementAmont = null, $remblaiTassement = null, $degradationParois = null, $degradationFond = null, $ensablement = null, $superficieIrriguee = null,  $sourceInformation = null,  $modeAcquisitionInformation = null)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_bh_04_donnees_collectees (id_infrastructure, beton_existence_fissure_sur_la_structure_en_beton, beton_existence_ferraillage_visible, beton_existence_affoullement_au_pied_de_l_ouvrage, beton_existence_erosion_le_long_des_rives_amont_du_barrage, beton_ancrage_de_l_ouvrage_aux_rives_du_cours_d_eau, remblai_fissuration_des_remblais, remblai_ravinement, remblai_erosion_le_long_recharge_aval, remblai_effet_de_batillage_de_la_parement_amont, remblai_tassement, degradation_des_parois, degradation_du_fond, date_information, source_information, mode_acquisition_infromation, ensablement, superficie_irriguee) VALUES (".intval($idInfrastructure).", '".$betonExistenceFissureBeton."', '".$betonExistenceFerraillageVisible."', '".$betonExistenceAffoullementPiedOuvrage."', '".$betonExistenceErosionLongRivesBarrage."', '".$betonAncrageOuvrageRivesCoursEau."', '".$remblaiFissurationDesRemblais."', '".$remblaiRavinement."', '".$remblaiErosionLongRechargeAval."', '".$remblaiEffetBatillageParementAmont."', '".$remblaiTassement."', '".$degradationParois."', '".$degradationFond."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$ensablement."', '".intval($superficieIrriguee)."')";
