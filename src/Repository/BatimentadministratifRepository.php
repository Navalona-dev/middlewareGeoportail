...
class BatimentadministratifRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $nomRouteRattache = null, $pointKmImplantation = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null )
    {
        ...
        $sql = "INSERT into t_ba_01_infrastructure (nom, indicatif, categorie,localite, commune_terrain, date_information, source_information, mode_acquisition_information, geom, district, photo_name1, photo_name2, photo_name3,  region, precision_categorie, photo1, photo2, photo3) VALUES ('".$nom."', '".$indicatif."', '".$categorie."', '".$localite."', '".$communeTerrain."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', ST_GeomFromText('POINT(" . $longitude . " " . $latitude . ")', 4326), '".$district."', '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$region."', '".$categoriePrecision."', '".$photo1."', '".$photo2."', '".$photo3."')";
    ...
    {
        $sql = "UPDATE t_ba_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = "UPDATE t_ba_07_batiment SET ".$setUpdate." where id_donnees_collectees = ".$dataCollecteId."";
    ...
    {
        $sql = "SELECT categorie.categorie as categorie FROM x_categorie as categorie  where categorie.infrastucture = 'Bâtiment administratif'";
    ...
    {
        $sql = "SELECT batiment.id as idbatiment FROM t_ba_07_batiment as batiment  where batiment.id_donnees_collectees = ".intval($dataCollecteId)."";
    ...
    {
        $sql = "SELECT infra.id as idDataCollecte FROM t_ba_06_donnees_collectees as infra  where infra.id_infrastructure = ".intval($infraId)."";
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_ba_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_ba_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_ba_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_ba_06_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_ba_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_ba_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $existanceTerrainFoot = null, $etatTerrainFoot = null,$existanceTerrainMixte, $etatTerrainMixte,  $sourceInformation = null,  $modeAcquisitionInformation = null, $existenceElectricite = null, $sourceElectricite = null,$etatElectricite, $existenceEau, $sourceEau, $etatEau, $existenceWc, $typeWc, $etatWc, $existenceDrainageEauPluviale, $etatDrainageEauPluviale, $existenceCloture, $typeCloture, $etatCloture)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_ba_06_donnees_collectees (id_infrastructure, existance_terrain_foot, etat_terrain_foot, existance_terrain_mixte, etat_terrain_mixte, date_information, source_information, mode_acquisition_information, existence_eau, source_eau, etat_eau, existence_electricite, source_electricite, etat_electricite, existence_wc, type_wc, etat_wc, existence_drainage_eau_pluviale, etat_drainage_eau_pluviale, existence_cloture, type_cloture, etat_cloture) VALUES (".intval($idInfrastructure).", '".$existanceTerrainFoot."', '".$etatTerrainFoot."', '".$existanceTerrainMixte."', '".$etatTerrainMixte."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$existenceEau."', '".$sourceEau."', '".$etatEau."', '".$existenceElectricite."', '".$sourceElectricite."', '".$etatElectricite."', '".$existenceWc."', '".$typeWc."', '".$etatWc."', '".$existenceDrainageEauPluviale."', '".$etatDrainageEauPluviale."', '".$existenceCloture."', '".$typeCloture."', '".$etatCloture."')";
    ...
    public function addInfrastructureDonneCollecteBatiment($idDonneesCollectees = null, $numeroBatiment = null, $batimentDur = null,$nombreNiveau, $affectation,  $typeFondation = null,  $moellonExistenceFissure = null, $moellonExistenceAffouillement = null, $betonExistenceFerraillageVisible = null,$moellonBetonExistenceFissure, $moellonBetonExistenceAffouillement, $moellonBetonExistenceFrerraillageVisible, $terreBriqueExistenceAffouillement, $pourvuMur, $murCompletude, $murExistenceFissure, $pourvuPoteau, $poteauExistenceFerraillageVisible, $typeSol, $solBetonExistenceFissure, $solParquetExistenceSolivePourrie, $solParquetExistenceParquetPourri, $solCarreauExistenceCarreauCasse, $typePlafond, $etatPlafond, $typeToiture, $toitureTuileExistenceFuite, $toitureToleExistenceInfiltration, $toitureTerasseExistenceFissure, $toitureTerasseExistenceFuite, $typeCharpente, $charpenteMetalliqueExistenceRouille, $charpenteBoisExistencePourriture, $pourvuPorte, $completudePorte, $etatPorte, $pourvuFenetre, $completudeFenetre, $etatFenetre, $etatBatiment, $precisionTypeFondation, $photo1, $photo2, $photo3, $photo4)
    {   
        /*$sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();*/
        //$sql = "INSERT into t_ba_07_batiment (id_donnees_collectees, numero_batiment, batiment_en_dur, nombre_niveau, affectation, type_fondation, moellon_existence_fissure, moellon_existence_affouillement, beton_existence_ferraillage_visible, moellon_beton_existence_fissure, moellon_beton_existence_affouillement, moellon_beton_existence_frerraillage_visible, terre_brique_existence_affouillement, pourvu_mur, mur_completude, mur_existence_fissure, pourvu_poteau, poteau_existence_ferraillage_visible, type_sol, sol_beton_existence_fissure, sol_parquet_existence_solive_pourrie, sol_parquet_existence_parquet_pourri, sol_carreau_existence_carreau_casse, type_plafond, etat_plafond, type_toiture, toiture_tuile_existence_fuite, toiture_tole_existence_infiltration, toiture_terasse_existence_fissure, toiture_terasse_existence_fuite, type_charpente, charpente_metallique_existence_rouille, charpente_bois_existence_pourriture, pourvu_porte, completude_porte, etat_porte, pourvu_fenetre, completude_fenetre, etat_fenetre, etat_batiment, precision_type_fondation, photo1, photo2, photo3, photo4) VALUES (".intval($idInfrastructure).", '".$existanceTerrainFoot."', '".$etatTerrainFoot."', '".$existanceTerrainMixte."', '".$etatTerrainMixte."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$existenceEau."', '".$sourceEau."', '".$etatEau."', '".$existenceElectricite."', '".$sourceElectricite."', '".$etatElectricite."', '".$existenceWc."', '".$typeWc."', '".$etatWc."', '".$existenceDrainageEauPluviale."', '".$etatDrainageEauPluviale."', '".$existenceCloture."', '".$typeCloture."', '".$etatCloture."')";
        $sql = "INSERT into t_ba_07_batiment (id_donnees_collectees, numero_batiment, batiment_en_dur, nombre_niveau, affectation, type_fondation, moellon_existence_fissure, moellon_existence_affouillement, beton_existence_ferraillage_visible, moellon_beton_existence_fissure, moellon_beton_existence_affouillement, moellon_beton_existence_frerraillage_visible, terre_brique_existence_affouillement, pourvu_mur, mur_completude, mur_existence_fissure, pourvu_poteau, poteau_existence_ferraillage_visible, type_sol, sol_beton_existence_fissure, sol_parquet_existence_solive_pourrie, sol_parquet_existence_parquet_pourri, sol_carreau_existence_carreau_casse, type_plafond, etat_plafond, type_toiture, toiture_tuile_existence_fuite, toiture_tole_existence_infiltration, toiture_terasse_existence_fissure, toiture_terasse_existence_fuite, type_charpente, charpente_metallique_existence_rouille, charpente_bois_existence_pourriture, pourvu_porte, completude_porte, etat_porte, pourvu_fenetre, completude_fenetre, etat_fenetre, etat_batiment, precision_type_fondation, photo1, photo2, photo3, photo4) VALUES (".intval($idDonneesCollectees).", '".$numeroBatiment."', '".$batimentDur."', '".$nombreNiveau."', '".$affectation."', '".$typeFondation."', '".$moellonExistenceFissure."', '".$moellonExistenceAffouillement."', '".$betonExistenceFerraillageVisible."', '".$moellonBetonExistenceFissure."', '".$moellonBetonExistenceAffouillement."', '".$moellonBetonExistenceFrerraillageVisible."', '".$terreBriqueExistenceAffouillement."', '".$pourvuMur."', '".$murCompletude."', '".$murExistenceFissure."', '".$pourvuPoteau."', '".$poteauExistenceFerraillageVisible."', '".$typeSol."', '".$solBetonExistenceFissure."', '".$solParquetExistenceSolivePourrie."', '".$solParquetExistenceParquetPourri."', '".$solCarreauExistenceCarreauCasse."', '".$typePlafond."', '".$etatPlafond."', '".$typeToiture."', '".$toitureTuileExistenceFuite."', '".$toitureToleExistenceInfiltration."', '".$toitureTerasseExistenceFissure."', '".$toitureTerasseExistenceFuite."', '".$typeCharpente."', '".$charpenteMetalliqueExistenceRouille."', '".$charpenteBoisExistencePourriture."', '".$charpenteMetalliqueExistenceRouille."', '".$pourvuPorte."', '".$completudePorte."', '".$etatPorte."', '".$pourvuFenetre."', '".$completudeFenetre."', '".$etatFenetre."', '".$completudeFenetre."', '".$etatBatiment."', '".$precisionTypeFondation."', '".$photo1."', '".$photo2."', '".$photo3."', '".$photo4."')";
        $conn = $this->entityManager->getConnection();
        $query = $conn->prepare($sql);
        $query->execute();
        $id = $conn->lastInsertId();
    ...
    public function addInfrastructurePlanMasse($idInfrastructure = null, $photo = null)
    {   
        /*$sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();*/
        //$sql = "INSERT into t_ba_07_batiment (id_donnees_collectees, numero_batiment, batiment_en_dur, nombre_niveau, affectation, type_fondation, moellon_existence_fissure, moellon_existence_affouillement, beton_existence_ferraillage_visible, moellon_beton_existence_fissure, moellon_beton_existence_affouillement, moellon_beton_existence_frerraillage_visible, terre_brique_existence_affouillement, pourvu_mur, mur_completude, mur_existence_fissure, pourvu_poteau, poteau_existence_ferraillage_visible, type_sol, sol_beton_existence_fissure, sol_parquet_existence_solive_pourrie, sol_parquet_existence_parquet_pourri, sol_carreau_existence_carreau_casse, type_plafond, etat_plafond, type_toiture, toiture_tuile_existence_fuite, toiture_tole_existence_infiltration, toiture_terasse_existence_fissure, toiture_terasse_existence_fuite, type_charpente, charpente_metallique_existence_rouille, charpente_bois_existence_pourriture, pourvu_porte, completude_porte, etat_porte, pourvu_fenetre, completude_fenetre, etat_fenetre, etat_batiment, precision_type_fondation, photo1, photo2, photo3, photo4) VALUES (".intval($idInfrastructure).", '".$existanceTerrainFoot."', '".$etatTerrainFoot."', '".$existanceTerrainMixte."', '".$etatTerrainMixte."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$existenceEau."', '".$sourceEau."', '".$etatEau."', '".$existenceElectricite."', '".$sourceElectricite."', '".$etatElectricite."', '".$existenceWc."', '".$typeWc."', '".$etatWc."', '".$existenceDrainageEauPluviale."', '".$etatDrainageEauPluviale."', '".$existenceCloture."', '".$typeCloture."', '".$etatCloture."')";
        $sql = "INSERT into t_ba_02_plan_masse (id_infrastructure, photo) VALUES (".intval($idInfrastructure).", '".$photo."')";
        $conn = $this->entityManager->getConnection();
        $query = $conn->prepare($sql);
        $query->execute();
        $id = $conn->lastInsertId();
