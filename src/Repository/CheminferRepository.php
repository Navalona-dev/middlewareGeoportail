...
class CheminferRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($ligne = null, $gareDebut = null, $gareFin = null, $pkDebut = null, $pkFin = null, $indicatif = null, $nomRouteRattache = null, $pointKmImplantation = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $coordonnees = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null )
    {
        ...
        $ligne = pg_escape_string($ligne);
        $gareFin = pg_escape_string($gareFin);
        $gareDebut = pg_escape_string($gareDebut);
        $sql = "INSERT into t_cf_01_infrastructure (geom, ligne, gare_debut, gare_fin, pk_debut, commune_sur_terrain,localite, date_information, source_information, mode_acquisition_information, photo_name1, photo_name2, photo_name3, region, district, indicatif, pk_fin, photo1, photo2, photo3) VALUES (ST_GeomFromText('LINESTRING(".$coordonnees.")'), '".$ligne."', '".$gareDebut."', '".$gareFin."', '".intval($pkDebut)."', '".$communeTerrain."', '".$localite."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."',  '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$region."', '".$district."', '".$indicatif."', '".intval($pkFin)."', '".$photo1."', '".$photo2."', '".$photo3."')";
    ...
    {
        $sql = "UPDATE t_cf_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_cf_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_cf_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_cf_02_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_cf_04_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_cf_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_cf_02_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $complétudeDesRails = null, $typeTraverse = null,$existenceTraversePourrie, $existenceTraverseRouillee, $baseGravillon,  $sourceInformation = null,  $modeAcquisitionInformation = null)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_cf_04_donnees_collectees (id_infrastructure, complétude_des_rails, type_de_traverse, existence_de_traverse_pourrie, existence_de_traverse_rouillee, base_en_gravillon, date_information, source_information, mode_acquisition_information) VALUES (".intval($idInfrastructure).", '".$complétudeDesRails."', '".$typeTraverse."', '".$existenceTraversePourrie."', '".$existenceTraverseRouillee."', '".$baseGravillon."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."')";
