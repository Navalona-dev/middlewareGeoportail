...
class CheminferRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = 'SELECT infra.id as infra_id, infra.ligne as ligne, infra.gare_debut as gare_debut, infra.gare_fin as gare_fin, infra.pk_debut as pk_debut, infra.pk_fin as pk_fin, infra.localite, infra.commune_terrain, infra.date_information, infra.source_information as source_information, infra.mode_acquisition_information as mode_acquisition_information, infra.district,  ST_X(infra.geom) AS longitude, ST_Y(infra.geom) AS latitude, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3  FROM t_cf_01_infrastructure as infra';
