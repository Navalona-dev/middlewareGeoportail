...
class CunetteRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $indicatif = null, $categorie = null, $nomRouteRattache = null, $pointKmImplantation = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $coordonnees = null , $district = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null)
    {
        ...
        $sql = "INSERT into t_cu_01_infrastructure (geom, nom, nom_de_la_route_a_qui_il_est_rattache, localite, categorie, date_information, source_information, mode_acquisition_information,  photo1, photo2, photo3, photo_name1, photo_name2, photo_name3, indicatif, point_kilometrique_de_son_implantation, commune_terrain, region, district) VALUES (ST_GeomFromText('LINESTRING(".$coordonnees.")'), '".$nom."', '".$nomRouteRattache."', '".$localite."', '".$categorie."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$photo1."', '".$photo2."', '".$photo3."', '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$indicatif."', '".$pointKmImplantation."', '".$communeTerrain."', '".$region."', '".$district."')";
