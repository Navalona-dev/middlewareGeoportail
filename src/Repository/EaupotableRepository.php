...
class EaupotableRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $volumeReservoir = null, $pointKmImplantation = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null, $localiteBeneficiaire = null, $communeBeneficiaire = null )
    {
        ...
        $categorie = pg_escape_string($categorie);
        
        $categoriePrecision = pg_escape_string($categoriePrecision);
        $sql = "INSERT into t_ep_01_infrastructure (nom, indicatif, categorie,volume_reservoir, commune_terrain, localite, date_information, source_information, mode_acquisition_information, geom, photo_name1, photo_name2, photo_name3, precision_categorie, region, district, photo1, photo2, photo3) VALUES ('".$nom."', '".$indicatif."', '".$categorie."', '".intval($volumeReservoir)."', '".$communeTerrain."', '".$localite."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', ST_GeomFromText('POINT(" . $longitude . " " . $latitude . ")', 4326), '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$categoriePrecision."', '".$region."', '".$district."', '".$photo1."', '".$photo2."', '".$photo3."')";
    ...
    public function getOneInfraInfo($infraId)
    {
        ...
        END AS duree_reelle_de_la_traversee, dc.etat_de_la_coque_du_bac as data__etat_de_la_coque_du_bac, dc.etat_du_moteur_du_bac as data__etat_du_moteur_du_bac, dc.date_information as data__date_information, dc.source_information as data__source_information, dc.mode_acquisition_information as data__mode_acquisition_information, trav.id as travaux__id, trav.id_infrastructure as travaux__id_infrastructure, trav.objet as travaux__objet, trav.consistance_travaux as travaux__consistance_travaux, trav.maitre_ouvrage as travaux__maitre_ouvrage, trav.maitre_ouvrage_delegue as travaux__maitre_ouvrage_delegue, trav.maitre_oeuvre as travaux__maitre_oeuvre, trav.id_controle_surveillance as travaux__id_controle_surveillance, trav.mode_passation as travaux__mode_passation, trav.porte_appel_offre as travaux__porte_appel_offre, trav.montant as travaux__montant, trav.numero_contrat as travaux__numero_contrat, trav.date_contrat as travaux__date_contrat, trav.date_ordre_service as travaux__date_ordre_service, trav.id_titulaire as travaux__id_titulaire, trav.resultat_travaux as travaux__resultat_travaux, trav.motif_rupture_contrat as travaux__motif_rupture_contrat, trav.date_reception_provisoire as travaux__date_reception_provisoire, trav.date_reception_definitive as travaux__date_reception_definitive, trav.ingenieur_reception_provisoire as travaux__ingenieur_reception_provisoire, trav.ingenieur_reception_definitive as travaux__ingenieur_reception_definitive, trav.date_information as travaux__date_information, trav.source_information as travaux__source_information, trav.mode_acquisition_information as travaux__mode_acquisition_information, trav.bailleur as travaux__bailleur, etude.id as etude__id, etude.id_infrastructure as etude__id_infrastructure, etude.objet_contrat as etude__objet_contrat, etude.consistance_contrat as etude__consistance_contrat, etude.entite as etude__entite, etude.id_titulaire as etude__id_titulaire, etude.montant_contrat as etude__montant_contrat, etude.numero_contrat as etude__numero_contrat, etude.mode_passation as etude__mode_passation, etude.porte_appel_offre as etude__porte_appel_offre, etude.date_contrat as etude__date_contrat, etude.date_ordre_service as etude__date_ordre_service, etude.resultat_prestation as etude__resultat_prestation, etude.motif_rupture_contrat as etude__motif_rupture_contrat, etude.date_information as etude_date_information, etude.source_information as etude__source_information, etude.mode_acquisition_information as etude__mode_acquisition_information, etude.bailleur as etude__bailleur  FROM t_ep_01_infrastructure as infra LEFT JOIN t_ep_03_situation as situation ON infra.id = situation.id_infrastructure  LEFT JOIN t_ep_05_donnees_collectees as dc ON infra.id = dc.id_infrastructure  LEFT JOIN t_ep_08_travaux as trav ON infra.id = trav.id_infrastructure LEFT JOIN t_ep_10_etudes as etude ON infra.id = etude.id_infrastructure where infra.id = ".$infraId."";*/

        $sql = "SELECT infra.id as infra_id, infra.categorie, infra.indicatif, infra.nom, infra.volume_reservoir, infra.localite, infra.region, infra.commune_terrain, infra.date_information, infra.source_information as source_information, infra.mode_acquisition_information as mode_acquisition_information, infra.district, infra.region,  ST_X(infra.geom) AS long, ST_Y(infra.geom) AS lat, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3, situation.id as situation__id, situation.id_infrastructure as situation__id_infrastructure, situation.fonctionnel as situation__fonctionnel, situation.raison as situation__raison, situation.date_information as situation__date_information, situation.source_information as situation__source_information, situation.mode_acquisition_information as situation__mode_acquisition_information, situation.etat as situation__etat, situation.raison as situation__raison, lb.id as beneficiaire__id, dc.id as data__id, dc.id_infrastructure as data__id_infrastructure, dc.aepg_existence_fissure_sur_le_reservoir as data__aepg_existence_fissure_sur_le_reservoir, dc.date_information as data__date_information, dc.source_information as data__source_information, dc.mode_acquisition_information as data__mode_acquisition_information, dc.aepg_fuite_sur_le_reservoir as data__aepg_fuite_sur_le_reservoir, dc.aepg_existence_ferraillage_visible_sur_le_reservoir as data__aepg_existence_ferraillage_visible_sur_le_reservoir, dc.aepg_completude_tuyaux as data__aepg_completude_tuyaux, dc.aepg_existence_fuite_sur_les_tuyaux as data__aepg_existence_fuite_sur_les_tuyaux, dc.aepg_nombre_borne_fontaine as data__aepg_nombre_borne_fontaine, dc.aepg_nombre_borne_fontaine_fonctionnel as data__aepg_nombre_borne_fontaine_fonctionnel, dc.forage_degradation_de_l_ouvrage_de_surface_en_maconnerie as data__forage_degradation_de_l_ouvrage_de_surface_en_maconnerie, dc.forage_etat_global_materiel as data__forage_etat_global_materiel, dc.jirama_etat_global_chateau_eau as data__jirama_etat_global_chateau_eau, dc.jirama_etat_global_materiels_machine as data__jirama_etat_global_materiels_machine, dc.puits_degradation_de_l_ouvrage_de_surface_en_maconnerie data__puits_degradation_de_l_ouvrage_de_surface_en_maconnerie, dc.puits_etat_pompe as data__puits_etat_pompe, lb.localite as beneficiaire__localite, lb.commune as beneficiaire__commune, trav.id as travaux__id, trav.id_infrastructure as travaux__id_infrastructure, trav.objet as travaux__objet, trav.consistance_travaux as travaux__consistance_travaux, trav.maitre_ouvrage as travaux__maitre_ouvrage, trav.maitre_ouvrage_delegue as travaux__maitre_ouvrage_delegue, trav.maitre_oeuvre as travaux__maitre_oeuvre, trav.id_controle_surveillance as travaux__id_controle_surveillance, trav.mode_passation as travaux__mode_passation, trav.porte_appel_offre as travaux__porte_appel_offre, trav.montant as travaux__montant, trav.numero_contrat as travaux__numero_contrat, trav.date_contrat as travaux__date_contrat, trav.date_ordre_service as travaux__date_ordre_service, trav.id_titulaire as travaux__id_titulaire, trav.resultat_travaux as travaux__resultat_travaux, trav.motif_rupture_contrat as travaux__motif_rupture_contrat, trav.date_reception_provisoire as travaux__date_reception_provisoire, trav.date_reception_definitive as travaux__date_reception_definitive, trav.ingenieur_reception_provisoire as travaux__ingenieur_reception_provisoire, trav.ingenieur_reception_definitive as travaux__ingenieur_reception_definitive, trav.date_information as travaux__date_information, trav.source_information as travaux__source_information, trav.mode_acquisition_information as travaux__mode_acquisition_information, trav.bailleur as travaux__bailleur, etude.id as etude__id, etude.id_infrastructure as etude__id_infrastructure, etude.objet_contrat as etude__objet_contrat, etude.consistance_contrat as etude__consistance_contrat, etude.entite as etude__entite, etude.id_titulaire as etude__id_titulaire, etude.montant_contrat as etude__montant_contrat, etude.numero_contrat as etude__numero_contrat, etude.mode_passation as etude__mode_passation, etude.porte_appel_offre as etude__porte_appel_offre, etude.date_contrat as etude__date_contrat, etude.date_ordre_service as etude__date_ordre_service, etude.resultat_prestation as etude__resultat_prestation, etude.motif_rupture_contrat as etude__motif_rupture_contrat, etude.date_information as etude_date_information, etude.source_information as etude__source_information, etude.mode_acquisition_information as etude__mode_acquisition_information, etude.bailleur as etude__bailleur  FROM t_ep_01_infrastructure as infra LEFT JOIN t_ep_03_situation as situation ON infra.id = situation.id_infrastructure  LEFT JOIN t_ep_05_donnees_collectees as dc ON infra.id = dc.id_infrastructure LEFT JOIN t_ep_02_localites_beneficieires as lb ON infra.id = lb.id_infrastructure LEFT JOIN t_ep_02_localites_beneficieires as lb on infra.id = lb.id_infrastructure  LEFT JOIN t_ep_06_travaux as trav ON infra.id = trav.id_infrastructure LEFT JOIN t_ep_10_etudes as etude ON infra.id = etude.id_infrastructure where infra.id = ".$infraId."";
    ...
    {
        $sql = "UPDATE t_ep_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = "SELECT categorie.categorie as categorie FROM x_categorie as categorie  where categorie.infrastucture = 'Eau potable'";
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_ep_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_ep_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_ep_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_ep_05_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                case 'localite_beneficiaire':
                    $table = "t_ep_02_localites_beneficieires";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_ep_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_ep_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $aepgFuiteReservoir = null, $aepgExistenceFissureReservoir = null,$aepgExistenceFerraillageVisibleReservoir, $aepgCompletudeTuyaux, $aepgExistenceFuiteTuyaux, $aepgNombreBorneFontaine = null, $aepgNombreBorneFontaineFonctionnel = null,$forageDegradationOuvrageSurfaceMaconnerie, $forageEtatGlobalMateriel, $jiramaEtatGlobalChateauEau,  $sourceInformation = null,  $modeAcquisitionInformation = null,  $jiramaEtatGlobalMaterielsMachine = null,  $puitsDegradationOuvrageSurfaceMaconnerie = null, $puitsEtatPompe = null)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
    ...
    public function addInfrastructureLocaliteBeneficiaire($idInfrastructure = null, $localite = null, $commune = null)
    {   
        $localite = pg_escape_string($localite);
        $commune = pg_escape_string($commune);
        $sql = "INSERT into t_ep_02_localites_beneficieires (id_infrastructure, localite, commune) VALUES (".intval($idInfrastructure).", '".$localite."', '".$commune."')";
