...
class GareroutiereRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = "SELECT categorie.categorie as categorie FROM x_categorie as categorie  where categorie.infrastucture = 'Gare routière'";
    ...
    public function getOneInfraInfo($infraId)
    {
        ...
        WHEN infra.categorie = 'Autre à préciser' THEN NULL 
