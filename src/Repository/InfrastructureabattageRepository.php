...
class InfrastructureabattageRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = "UPDATE t_ia_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $abattage = pg_escape_string('Infrastructure d\'abattage');
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_ia_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_ia_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_ia_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_ia_06_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_ia_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_ia_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
