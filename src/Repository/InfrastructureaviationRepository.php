...
class InfrastructureaviationRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $longueurPiste = null, $largeurPiste = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null )
    {
        ...
        $sql = "INSERT into t_iv_01_infrastructure (nom, indicatif, categorie, localite, commune_terrain, longueur_piste, largeur_piste, date_information, source_information, mode_acquisition_information, geom, photo_name1, photo_name2, photo_name3, region, district, photo1, photo2, photo3, precision_categorie) VALUES ('".$nom."', '".$indicatif."', '".$categorie."', '".$localite."', '".$communeTerrain."', '".floatval($longueurPiste)."', '".floatval($largeurPiste)."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', ST_GeomFromText('POINT(" . $longitude . " " . $latitude . ")', 4326), '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$region."', '".$district."', '".$photo1."', '".$photo2."', '".$photo3."', '".$categoriePrecision."')";
    ...
    {
        $sql = "UPDATE t_iv_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $abattage = pg_escape_string('Infrastructure d\'aviation');
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_iv_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_iv_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_iv_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_iv_06_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_iv_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_iv_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $revetementPiste = null, $bitumeExistencePelade = null, $bitumeExistenceFissure = null, $bitumeExistenceTrou = null, $existencePoteauxAlignement = null, $etatPoteauxAlignement = null, $enTerreTrou = null, $betonFissure = null, $betonExistenceFerraillageVisible = null, $betonExistenceTrou = null, $existenceElectricite = null, $sourceElectricite = null,$etatElectricite, $existenceEau, $sourceEau, $etatEau, $existenceWc, $typeWc, $etatWc, $existenceDrainageEauPluviale, $etatDrainageEauPluviale, $existenceCloture, $typeCloture, $etatCloture,  $sourceInformation = null,  $modeAcquisitionInformation = null)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $sourceEau = pg_escape_string($sourceEau);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_iv_06_donnees_collectees (id_infrastructure, revetement_piste, bitume_existence_pelade, bitume_existence_fissure, bitume_existence_trou, existence_poteaux_alignement, etat_poteaux_alignement, existence_eau, source_eau, etat_eau, existence_electricite, source_electricite, etat_electricite, existence_wc, type_wc, etat_wc, existence_drainage_eau_pluviale, etat_drainage_eau_pluviale, existence_cloture, type_cloture, etat_cloture, date_information, source_information, mode_acquisition_information, en_terre_trou, beton_fissure, beton_existence_ferraillage_visible, beton_existence_trou) VALUES (".intval($idInfrastructure).", '".$revetementPiste."', '".$bitumeExistencePelade."', '".$bitumeExistenceFissure."', '".$bitumeExistenceTrou."', '".$existencePoteauxAlignement."', '".$etatPoteauxAlignement."', '".$existenceEau."', '".$sourceEau."', '".$etatEau."', '".$existenceElectricite."', '".$sourceElectricite."', '".$etatElectricite."', '".$existenceWc."', '".$typeWc."', '".$etatWc."', '".$existenceDrainageEauPluviale."', '".$etatDrainageEauPluviale."', '".$existenceCloture."', '".$typeCloture."', '".$etatCloture."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$enTerreTrou."', '".$betonFissure."', '".$betonExistenceFerraillageVisible."', '".$betonExistenceTrou."')";
