...
class InfrastructuresportiveRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $volumeReservoir = null, $pointKmImplantation = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null )
    {
        ...
        $sql = "INSERT into t_is_01_infrastructure (nom, indicatif, categorie, localite, commune_terrain, date_information, source_information, mode_acquisition_information, geom, photo_name1, photo_name2, photo_name3, region, district, photo1, photo2, photo3, precision_categorie) VALUES ('".$nom."', '".$indicatif."', '".$categorie."', '".$localite."', '".$communeTerrain."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', ST_GeomFromText('POINT(" . $longitude . " " . $latitude . ")', 4326), '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$region."', '".$district."', '".$photo1."', '".$photo2."', '".$photo3."', '".$categoriePrecision."')";
    ...
    {
        $sql = "UPDATE t_is_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_is_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_is_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_is_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_is_06_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_is_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_is_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $existenceGradinTribune = null, $etatGradinTribune = null, $etatGlobalAiresJeu = null, $etatPoteaux = null, $existencProjecteurs = null, $etatProjecteurs = null, $existenceVestiaire = null, $etatVestiaire = null, $existenceWcVestiaire = null, $etatWcVestiaire = null, $existenceDoucheVestiaire = null, $etatDoucheVestiaire = null, $existenceMobiliersVestiaire = null, $etatMobiliersVestiaire = null, $existencePiscine = null, $etatMoteur = null, $etatBassin = null, $etatBordPiscine = null, $EtatPisteAthletisme = null, $existenceElectricite = null, $sourceElectricite = null,$etatElectricite, $existenceEau, $sourceEau, $etatEau, $existenceWc, $typeWc, $etatWc, $existenceDrainageEauPluviale, $etatDrainageEauPluviale, $existenceCloture, $typeCloture, $etatCloture,  $sourceInformation = null,  $modeAcquisitionInformation = null)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        ...
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_is_06_donnees_collectees (id_infrastructure, existence_gradin_tribune, etat_gradin_tribune, etat_global_des_aires_de_jeu, etat_des_poteaux, existence_des_projecteurs, etat_des_projecteurs, existence_du_vestiaire, etat_du_vestiaire, existence_wc_dans_le_vestiaire, etat_du_wc_dans_le_vestiaire, existence_douche_dans_le_vestiaire, etat_de_la_douche_dans_le_vestiaire, existence_des_mobiliers_dans_le_vestiaire, etat_des_mobiliers_dans_vestiaire, existence_eau, source_eau, etat_eau, existence_electricite, source_electricite, etat_electricite, existence_wc, type_wc, etat_wc, existence_drainage_eau_pluviale, etat_drainage_eau_pluviale, existence_cloture, type_cloture, etat_cloture, date_information, source_information, mode_acquisition_information, etat_moteur, etat_bassin, etat_bord_de_la_piscine, etat_piste_athletisme) VALUES (".intval($idInfrastructure).", '".$existenceGradinTribune."', '".$etatGradinTribune."', '".$etatGlobalAiresJeu."', '".$etatPoteaux."', '".$existencProjecteurs."', '".$etatProjecteurs."', '".$existenceVestiaire."', '".$etatVestiaire."', '".$existenceWcVestiaire."', '".$etatWcVestiaire."', '".$existenceDoucheVestiaire."', '".$etatDoucheVestiaire."', '".$existenceMobiliersVestiaire."', '".$etatMobiliersVestiaire."', '".$existenceEau."', '".$sourceEau."', '".$etatEau."', '".$existenceElectricite."', '".$sourceElectricite."', '".$etatElectricite."', '".$existenceWc."', '".$typeWc."', '".$etatWc."', '".$existenceDrainageEauPluviale."', '".$etatDrainageEauPluviale."', '".$existenceCloture."', '".$typeCloture."', '".$etatCloture."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$existencePiscine."', '".$etatMoteur."', '".$etatBassin."', '".$etatBordPiscine."', '".$EtatPisteAthletisme."')";
