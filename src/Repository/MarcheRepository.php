...
class MarcheRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $marchandiseVendue = null, $lundiJourMarche = null, $mardiJourMarche = null, $mercrediJourMarche = null, $jeudiJourMarche = null, $vendrediJourMarche = null, $samediJourMarche = null, $dimancheJourMarche = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null )
    {
        ...
        $sql = "INSERT into t_ma_01_infrastructure (nom, indicatif, categorie, localite, commune_terrain, marchandise_vendue, lundi_jour_de_marche, mardi_jour_de_marche, mercredi_jour_de_marche, jeudi_jour_de_marche, vendredi_jour_de_marche, samedi_jour_de_marche, dimanche_jour_de_marche, date_information, source_information, mode_acquisition_information, geom, photo_name1, photo_name2, photo_name3, region, district, photo1, photo2, photo3, precision_categorie) VALUES ('".$nom."', '".$indicatif."', '".$categorie."', '".$localite."', '".$communeTerrain."', '".$marchandiseVendue."', '".$lundiJourMarche."', '".$mardiJourMarche."', '".$mercrediJourMarche."', '".$jeudiJourMarche."', '".$vendrediJourMarche."', '".$samediJourMarche."', '".$dimancheJourMarche."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', ST_GeomFromText('POINT(" . $longitude . " " . $latitude . ")', 4326), '".$photo_name1."', '".$photo_name2."', '".$photo_name3."', '".$region."', '".$district."', '".$photo1."', '".$photo2."', '".$photo3."', '".$categoriePrecision."')";
...
*/
    ...
    {
        $sql = "UPDATE t_ma_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $abattage = pg_escape_string('Marché');
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_ma_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
    ...
    {
        $sql = 'SELECT infra.id as infra_id, infra.nom as nom, infra.categorie, infra.marchandise_vendue, infra.lundi_jour_de_marche, infra.mardi_jour_de_marche, infra.mercredi_jour_de_marche, infra.jeudi_jour_de_marche, infra.vendredi_jour_de_marche, infra.samedi_jour_de_marche, infra.dimanche_jour_de_marche, infra.localite, infra.commune_terrain, infra.date_information, infra.source_information as source_information, infra.mode_acquisition_information as mode_acquisition_information, infra.district,  ST_X(infra.geom) AS longitude, ST_Y(infra.geom) AS latitude, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3  FROM t_ma_01_infrastructure as infra';
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_ma_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_ma_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_ma_06_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_ma_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_ma_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $existenceElectricite = null, $sourceElectricite = null,$etatElectricite, $existenceEau, $sourceEau, $etatEau, $existenceWc, $typeWc, $etatWc, $existenceDrainageEauPluviale, $etatDrainageEauPluviale, $existenceCloture, $typeCloture, $etatCloture,  $sourceInformation = null,  $modeAcquisitionInformation = null, $existenceEtales = null, $etatEtales = null )
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
