...
class PontRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = "SELECT categorie.categorie as categorie FROM x_categorie as categorie  where categorie.infrastucture = 'Pont'";
