...
class PontRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = 'SELECT infra.id as infra_id, infra.nom as nom, infra.localite, infra.commune_terrain, infra.nom_de_la_route_a_qui_il_est_rattache, infra.point_kilometrique_de_son_implantation, infra.date_information, infra.district,  ST_X(infra.geom) AS longitude, ST_Y(infra.geom) AS latitude, infra.photo_name1, infra.photo_name2, infra.photo_name3  FROM t_pnr_01_infrastructure as infra';
