...
class PortRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $categorie = null, $indicatif = null, $type = null, $pointKmImplantation = null, $localite = null, $communeTerrain = null, $sourceInformation = null, $modeAcquisitionInformation = null, $longitude = null, $latitude = null, $district = null, $categoriePrecision = null, $chargeMaximum = null, $region = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null, $moisOuverture = null, $moisFermeture = null )
    {
    ...
    {
        $sql = "UPDATE t_pr_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_pr_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function cleanTablesByIdInfrastructure($idInfrastructure = null, $type = null)
    {
        if (null != $idInfrastructure && $type != null) {
            ...
            $table = 't_pr_01_infrastructure';
            $colonne = "id";
            $selectedcolonne = "id";
            switch ($type) {
                case 'situation':
                    $table = "t_pr_03_situation";
                ...
                /*case 'surface':
                    ...
                    break;*/
                case 'data':
                    $table = "t_pr_06_donnees_collectees";
                    $colonne = "id_infrastructure";
                    $selectedcolonne = "id";
                    break;
                /*case 'etat':
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_pr_01_infrastructure SET ".$updateColonneInfra." where id = ".$idInfra."";
    ...
    {   
        ...
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_pr_03_situation (id_infrastructure, fonctionnel, raison, date_information, source_information, mode_acquisition_information, etat) VALUES (".intval($idInfrastructure).", '".$fonctionnel."', '".$motif."', '".$dateInfo->format("Y-m-d")."', '".$sourceInfo."', '".$modeAcquisitionInformation."', '".$etat."')";
    ...
    public function addInfrastructureDonneCollecte($idInfrastructure = null, $existenceQuai = null, $existenceFissureQuai = null, $existenceFerraillageVisibleQuai = null, $existenceRade = null, $existenceFissureRade = null, $existenceFerraillageVisibleRade = null, $existenceDarse = null, $existenceFissureDarse = null, $existenceFerraillageVisibleDarse = null, $existenceRampeEau = null, $existenceFissureRampeEau = null, $existenceFerraillageVisibleRampeEau = null, $existenceElectricite = null, $sourceElectricite = null,$etatElectricite, $existenceEau, $sourceEau, $etatEau, $existenceWc, $typeWc, $etatWc, $existenceDrainageEauPluviale, $etatDrainageEauPluviale, $existenceCloture, $typeCloture, $etatCloture,  $sourceInformation = null,  $modeAcquisitionInformation = null)
    {   
        $sourceInformation = pg_escape_string($sourceInformation);
        $modeAcquisitionInformation = pg_escape_string($modeAcquisitionInformation);
        $dateInfo = new \DateTime();
        $sql = "INSERT into t_pr_06_donnees_collectees (id_infrastructure, existence_quai, existence_fissure_sur_le_quai, existence_ferraillage_visible_sur_le_quai, existence_rade, existence_fissure_sur_la_rade, existence_ferraillage_visible_sur_la_rade, existence_darse, existence_fissure_sur_la_darse, existence_ferraillage_visible_sur_la_darse, existence_rampe_de_mise_a_eau, existence_fissure_sur_la_rampe_de_mise_a_eau, existence_ferraillage_visible_sur_la_rampe_de_mise_eau, existence_eau, source_eau, etat_eau, existence_electricite, source_electricite, etat_electricite, existence_wc, type_wc, etat_wc, existence_drainage_eau_pluviale, etat_drainage_eau_pluviale, existence_cloture, type_cloture, etat_cloture, date_information, source_information, mode_acquisition_information, etat_moteur, etat_bassin, etat_bord_de_la_piscine, Etat_piste_athlétisme) VALUES (".intval($idInfrastructure).", '".$existenceQuai."', '".$existenceFissureQuai."', '".$existenceFerraillageVisibleQuai."', '".$existenceRade."', '".$existenceFissureRade."', '".$existenceFerraillageVisibleRade."', '".$existenceDarse."', '".$existenceFissureDarse."', '".$existenceFerraillageVisibleDarse."', '".$existenceRampeEau."', '".$existenceFissureRampeEau."', '".$existenceFerraillageVisibleRampeEau."', '".$existenceEau."', '".$sourceEau."', '".$etatEau."', '".$existenceElectricite."', '".$sourceElectricite."', '".$etatElectricite."', '".$existenceWc."', '".$typeWc."', '".$etatWc."', '".$existenceDrainageEauPluviale."', '".$etatDrainageEauPluviale."', '".$existenceCloture."', '".$typeCloture."', '".$etatCloture."', '".$dateInfo->format("Y-m-d")."', '".$sourceInformation."', '".$modeAcquisitionInformation."', '".$existencePiscine."', '".$etatMoteur."', '".$etatBassin."', '".$etatBordPiscine."', '".$EtatPisteAthlétisme."')";
