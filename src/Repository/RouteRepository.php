...
class RouteRepository extends ServiceEntityRepository
{
    ...
    {
        $dateInfo = new \DateTime();
        $sql = "UPDATE t_se_ro_infrastructure SET ".$updateColonneInfra." where gid = ".$idInfra."";
    ...
    {
       $sql = "SELECT accote.id as accotement__id, accote.id_infrastructure as accotement__id_infrastructure, accote.cote as accotement__cote, accote.revetue_degradation_de_la_surface as accotement__revetue_degradation_de_la_surface_accote, accote.revetue_dentelle_de_rive as accotement__revetue_dentelle_de_rive, accote.revetue_denivellation_entre_chaussée_et_accotement as accotement__revetue_denivellation_entre_chaussée_et_accotement, accote.revetue_destruction_par_affouillement_de_accotement as accotement__revetue_destruction_par_affouillement_de_accotement, accote.non_revetue_deformation_du_profil as accotement__non_revetue_deformation_du_profil, accote.revetu as accotement__revetu, accote.type as accotement__type, accote.precision_type as accotement__precision_type, accote.date_information as accotement__date_information, accote.source_information as accotement__source_information, accote.mode_acquisition_information as accotement__mode_acquisition_information, accote.reseau_divers as accotement__reseau_divers, accote.type_reseau as accotement__type_reseau  FROM t_ro_07_accotement as accote WHERE accote.id_infrastructure = ".intval($idRoute)."";
    ...
    {
        $sql = "select MAX(route.id) as id, route.nom as nom, MAX(route.num) as numero from y_liste_route as route where route.num is not null GROUP BY route.nom";
