...
class StationpesageRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = 'SELECT infra.id as infra_id, infra.nom as nom, infra.categorie, infra.localite, infra.commune_terrain, l.gid as id_route_rattache, l.gid as id_route_rattache, infra.nom_de_la_route_a_qui_il_est_rattache as nom_de_la_route_a_qui_il_est_rattache, infra.point_kilometrique_d_implantation, infra.date_information, infra.source_information as source_information, infra.mode_acquisition_information as mode_acquisition_information, infra.district,  ST_X(infra.geom) AS longitude, ST_Y(infra.geom) AS latitude, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3  FROM t_sp_01_infrastructure as infra LEFT JOIN y_liste_route as l ON infra.nom_de_la_route_a_qui_il_est_rattache = l.nom';
