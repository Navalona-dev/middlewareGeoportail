...
class StationpompageRepository extends ServiceEntityRepository
{
   ...
   /* public function getAllInfrastructuresBaseRoute()
    ...
    public function addInfrastructurePompe($idIdDataCollecte = null, $marquePompe = null, $debitNominal = null, $debitReel = null, $etatPompe = null)
    {   
        $marquePompe = pg_escape_string($marquePompe);
        $sql = "INSERT into t_so_08_pompes (id_donnees_collectees, marque_pompe, debit_nominal, debit_reel, etat_pompe) VALUES (".intval($idIdDataCollecte).", '".$marquePompe."', '".intval($debitNominal)."', '".intval($debitReel)."', '".$etatPompe."')";
