...
class TrajetrouteRepository extends ServiceEntityRepository
{
    ...
    public function addInfrastructure($nom = null, $nom_de_la_route_a_qui_il_est_rattache = null, $localite_depart = null, $localite_arrive = null, $pk_depart = null, $pk_arrive = null, $categorie = null, $sourceInformation = null, $modeAcquisitionInformation = null, $coordonnees = null, $photo1 = null, $photo2 = null, $photo3 = null, $photo_name1 = null, $photo_name2 = null, $photo_name3 = null )
    {
        ...
        $localite_arrive = pg_escape_string($localite_arrive);
        $localite_depart = pg_escape_string($localite_depart);
    ...
    {
        $sql = "UPDATE t_tj_01_infrastructure SET ".$setUpdate." where id = ".$idInfra."";
    ...
    {
        $sql = 'SELECT infra.id as infra_id, ST_AsText(infra.geom) as coordonnees, infra.nom as nom, l.gid as id_route_rattache, infra.nom_de_la_route_a_qui_il_est_rattache as nom_de_la_route_a_qui_il_est_rattache, infra.localite_depart, infra.localite_arrive, infra.pk_depart, infra.pk_arrive, infra.categorie, infra.date_information, infra.source_information, infra.mode_acquisition_information,  infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3  FROM t_tj_01_infrastructure as infra LEFT JOIN y_liste_route as l ON infra.nom_de_la_route_a_qui_il_est_rattache = l.nom';
    ...
    {
        $sql = "SELECT infra.id as infra_id, infra.photo1, infra.photo2, infra.photo3, infra.photo_name1, infra.photo_name2, infra.photo_name3 FROM t_tj_01_infrastructure as infra  where infra.id = ".intval($infraId)."";
   ...
   public function addInfrastructureRouteFourniture($objetContrat = null, $materiels = null, $entite = null, $modePassation = null, $porteAppelOffre = null, $montant = null, $idTitulaire = null, $numeroContrat = null, $dateContrat = null, $dateOrdre = null, $resultat = null, $raisonResiliation = null, $dateReceptionProvisoire = null, $dateReceptionDefinitive = null, $ingenieurReceptionProvisoire = null, $ingenieurReceptionDefinitive = null, $idInfrastructure = null, $bailleur = null, $consistanceContrat = null, $precisionPassation = null)
    {   
        $sql = "INSERT into t_tj_06_fourniture (objet_contrat, materiels, entite, bailleur, mode_passation, porte_appel_offre, id_titulaire, montant, date_contrat, numero_contrat, date_ordre, resultat, raison_resiliation, date_reception_provisoire, ingenieur_reception_provisoire, date_reception_definitive, ingenieur_reception_definitive, id_infrastructure, consistance_contrat, precision_passation) VALUES ('".$objetContrat."', '".$materiels."', '".$entite."', '".$bailleur."', '".$modePassation."', '".$porteAppelOffre."', ".intval($idTitulaire).", ".intval($montant).", '".$dateContrat->format("Y-m-d")."', '".$numeroContrat."', '".$dateOrdre->format("Y-m-d")."', '".$resultat."', '".$raisonResiliation."','".$dateReceptionProvisoire->format("Y-m-d")."', '".$ingenieurReceptionProvisoire."', '".$dateReceptionDefinitive->format("Y-m-d")."', '".$ingenieurReceptionDefinitive."', '".intval($idInfrastructure)."', '".$consistanceContrat."', '".$precisionPassation."')";
