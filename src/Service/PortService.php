...
class PortService
{
    ...
    {
        $result = $this->portRepository->addInfrastructureDonneCollecte($idInfrastructure, $data['existenceQuai'], $data['existenceFissureQuai'], $data['existenceFerraillageVisibleQuai'], $data['existenceRade'], $data['existenceFissureRade'], $data['existenceFerraillageVisibleRade'], $data['existenceDarse'], $data['existenceFerraillageVisibleDarse'], $data['existenceRampeEau'], $data['existenceFissureRampeEau'], $data['existenceFerraillageVisibleRampeEau'], $data['existenceElectricite'], $data['sourceElectricite'], $data['etatElectricite'], $data['existenceEau'], $data['sourceEau'], $data['etatEau'], $data['existenceWc'], $data['typeWc'], $data['etatWc'], $data['existenceDrainageEauPluviale'], $data['etatDrainageEauPluviale'], $data['existenceCloture'], $data['typeCloture'], $data['etatCloture'], $data['sourceInformationData'], $data['modeAcquisitionInformationData']);
